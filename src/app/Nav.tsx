...
export default function Nav() {
    ...
    return (
        <div className="">
            ...
            <div id="nav-div" className="fixed top-5 left-0 z-20 w-64 h-full transition-all duration-500 transform -translate-x-full bg-white shadow-lg lg:translate-x-0">
